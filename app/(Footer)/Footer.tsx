...
function Footer() {
  return (
      ...
      <div className="w-full h-auto flex flex-row items-center justify-evenly m-auto my-4 z-50 text-gray-200 flex-wrap">
        {/* Logo */}
        <Link href={"/"} className="w-auto h-auto flex flex-row items-center mb-3 800:mb-0">
          <Image
            src={"/j.png"}
            width={40}
            height={40}
        ...
        >
          ...
          <span className="text-[15px]">Jjulisanz@gmail.com</span>
        </a>
        {/* Phone */}
        <a
          href=""
