...
function SectionText() {
  return (
    <div className="w-full h-auto flex flex-col   items-center justify-center">
      ...
      >
        <span className="hidden 800:flex mb-0 1300:mb-[15px] text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500">
          Practice makes Perfect
        </span>
        <span className="flex 800:hidden text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500">
